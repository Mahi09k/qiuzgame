...
options = (("A. HyperText Transfer Protocol Secure", "B. HyperText Transfer Protocol Standard", "C. HyperText Transfer Program Server", "D. HyperText Transfer Procedure Service"),
           ("A. 123456", "B. P@ssw0rd!", "C. CorrectHorseBatteryStaple", "D. Tr0ub4dor&3"),
           ("A. Internet of Things", "B. Internet over Telephone", "C. Internal Operating Technology", "D. Internet over Transmission"),
           ("A. Phishing", "B. Spoofing", "C. DDoS (Distributed Denial of Service)", "D. Man-in-the-Middle"),
           ("A. To speed up internet connection", "B. To create a secure connection over a public network", "C. To store passwords securely", "D. To protect against viruses"),
           ("A. Anti-virus software", "B. Firewall", "C. User awareness and education", "D. Intrusion Detection System (IDS)"),
